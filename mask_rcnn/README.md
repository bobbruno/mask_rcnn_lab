...
This repo is a fork of the lab on [amazon-sagemaker-examples](https://github.com/awslabs/amazon-sagemaker-examples/tree/maskrcnn_inference/advanced_functionality/distributed_tensorflow_mask_rcnn), customized to be used as an independent lab.
